...
# label_frame= Label(frame3, bg = "white")
# label_frame.place(x=263, y=310,
#     width = 378,
#     height = 50)
# label_di= Label(label_frame, text="NOT WORKING", bg = "white")
...
def NaiveBayes():
    ...
    # def config_predic_label():
    #     label_di.configure(text = disease[a])
    #     print('done')
...
label_option = Label(frame1, text="")
...
label_symp= Label(frame2, text="NAMOka kingina", bg = "white")
